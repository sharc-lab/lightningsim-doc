...
entity GIN_compute_graphs_edge_embedding_weights_V_0_4 is 
    generic(
            DataWidth     : integer := 16; 
            AddressWidth     : integer := 10; 
            AddressRange    : integer := 780
    ); 
    port (
...
architecture rtl of GIN_compute_graphs_edge_embedding_weights_V_0_4 is 
