...
set id 206
set name GIN_compute_graphs_mac_muladd_3ns_6ns_6ns_8_4_1
...
set ce_signed 0
set out_width 8
set arg_lists {i0 {3 0 +} i1 {6 0 +} m {8 1 +} i2 {6 0 +} p {8 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set id 207
set name GIN_compute_graphs_mac_muladd_3ns_7ns_7ns_9_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { node_mlp_2_bias_V_0_address0 { O 8 vector } node_mlp_2_bias_V_0_ce0 { O 1 bit } node_mlp_2_bias_V_0_we0 { O 1 bit } node_mlp_2_bias_V_0_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { node_mlp_2_bias_V_1_address0 { O 8 vector } node_mlp_2_bias_V_1_ce0 { O 1 bit } node_mlp_2_bias_V_1_we0 { O 1 bit } node_mlp_2_bias_V_1_d0 { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 210 \
    name node_mlp_2_bias_in \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_node_mlp_2_bias_in \
    op interface \
    ports { node_mlp_2_bias_in { I 64 vector } } \
} "
}
