...
// ==============================================================
#ifndef GIN_compute_graphs_fifo_w16_d200_A_HH_
#define GIN_compute_graphs_fifo_w16_d200_A_HH_

#include <systemc>
using namespace std;
SC_MODULE(GIN_compute_graphs_fifo_w16_d200_A) {
    static const unsigned int DATA_WIDTH = 16;
    static const unsigned int ADDR_WIDTH = 8;
    static const unsigned int GIN_compute_graphs_fifo_w16_d200_A_depth = 201;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[GIN_compute_graphs_fifo_w16_d200_A_depth];
    ...
    SC_CTOR(GIN_compute_graphs_fifo_w16_d200_A) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < GIN_compute_graphs_fifo_w16_d200_A_depth; i++) {
    ...
    ~GIN_compute_graphs_fifo_w16_d200_A() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (GIN_compute_graphs_fifo_w16_d200_A_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < GIN_compute_graphs_fifo_w16_d200_A_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (GIN_compute_graphs_fifo_w16_d200_A_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > GIN_compute_graphs_fifo_w16_d200_A_depth) {
...
#endif //GIN_compute_graphs_fifo_w16_d200_A_HH_
